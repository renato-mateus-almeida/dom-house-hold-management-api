...
public class HouseHoldController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<HouseHoldDTO> update(@PathVariable Long id, @RequestBody HouseHoldDTO dto) throws HouseHoldNotFoundException {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(houseHoldService.update(id, dto));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<Void> delete(@PathVariable Long id) throws HouseHoldNotFoundException {
